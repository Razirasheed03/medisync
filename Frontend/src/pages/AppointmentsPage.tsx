  ...
  return (
    <>
      ...
      {appointmentsQuery.isPending ? (
        <LoadingBlock label="Loading appointments…" variant="table" />
        ...
        <>
          <Card className="overflow-x-auto p-0">
            <table className="w-full min-w-200 text-left text-sm">
              <thead>
                <tr className="border-b border-glass-border bg-white/50 text-left text-xs font-medium text-muted">
                  <th className="px-4 py-3.5 font-medium sm:px-5">Patient</th>
                  <th className="px-4 py-3.5 font-medium sm:px-5">Mobile</th>
                  {showDoctorFilter ? (
                    <th className="px-4 py-3.5 font-medium sm:px-5">Doctor</th>
                  ) : null}
                  <th className="px-4 py-3.5 font-medium sm:px-5">Department</th>
                  <th className="px-4 py-3.5 font-medium sm:px-5">Date</th>
                  <th className="px-4 py-3.5 font-medium sm:px-5">Time</th>
